...
class Router{
	...
	**/
	static function parse($url,$request){
		$url = trim($url,'/'); //retire le slach en debut et en fin de chaine de l'URL
		if(empty($url)){
		...
		$params = explode('/',$url); // separer les diifferents morceu de l'URL

		// Ajout du $prefixes de l'url d'administration
